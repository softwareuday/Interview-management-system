...
import { 
  ...
  CheckCircle, AlertCircle, Clock, Building, Filter
} from 'lucide-react';
            ...
            {filteredJobs.map(job => (
              <div key={job.id} className="job-card" onClick={() => openJobModal(job)}>
                <div className="job-card-header">
                  ...
                  <div className="job-type-badge">{JOB_TYPE_LABELS[job.jobType]}</div>
                </div>
                ...
                <div className="job-card-footer">
                  ...
                  {appliedJobs.has(job.id) ? (
                    ...
                    <button className="apply-btn-small" onClick={(e) => { e.stopPropagation(); openJobModal(job); }}>Apply Now</button>
                  )}
                </div>
              </div>
            ))}
            ...
            <div className="modal-content large" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="modal-body">
                <div className="job-overview">
                  <div className="overview-item"><Briefcase size={20} /><div><span className="label">Job Type</span><span className="value">{JOB_TYPE_LABELS[selectedJob.jobType]}</span></div></div>
              ...
              <div className="modal-footer">
                ...
                {appliedJobs.has(selectedJob.id) ? (
                  ...
                  <button onClick={() => handleApply(selectedJob.id)} className="btn btn-primary" disabled={applying}>
