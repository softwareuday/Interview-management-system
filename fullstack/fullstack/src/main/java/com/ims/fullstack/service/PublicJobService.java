...
//                hasApplied = applicationRepository
//                        .findByCandidate_IdAndJob_Id(finalCandidateId, job.getId())
//                        .isPresent();
//            }
//
...
//
//    /**
//     * 🔹 Backward-compatible method for existing controller
//     * GET /api/public/jobs
//     */
//    public List<JobResponse> getOpenJobsForCandidates(HttpServletRequest request) {
//        return getPublicJobs(0, 10, request).getContent();
//    }
//}
